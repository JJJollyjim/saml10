...
#[doc = "Reader of field `TAMPERS`"]
pub type TAMPERS_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TAMPERS`"]
pub struct TAMPERS_W<'a> {
    w: &'a mut W,
}
impl<'a> TAMPERS_W<'a> {
    #[doc = r"Sets the field bit"]
