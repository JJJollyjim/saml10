...
#[doc = "Reader of field `VC_SFERR`"]
pub type VC_SFERR_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `VC_SFERR`"]
pub struct VC_SFERR_W<'a> {
    w: &'a mut W,
}
impl<'a> VC_SFERR_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Reader of field `SDME`"]
pub type SDME_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `SDME`"]
pub struct SDME_W<'a> {
    w: &'a mut W,
}
impl<'a> SDME_W<'a> {
...
impl R {
    ...
    pub fn vc_sferr(&self) -> VC_SFERR_R {
        VC_SFERR_R::new(((self.bits >> 11) & 0x01) != 0)
    }
    ...
    pub fn sdme(&self) -> SDME_R {
        SDME_R::new(((self.bits >> 20) & 0x01) != 0)
    }
